"""
LSTM Model for Hate Speech Classification
...
class LSTMModel:
    ...
    def __init__(self, config: Dict = None):
        ...
        Args:
            config: Model configuration (uses LSTM_CONFIG if None)
        """
    ...
    def train(
        ...
        # Get callbacks
        checkpoint_path = str(MODEL_FILES['lstm'])
    ...
    def save(self, filepath: str = None):
        ...
        filepath = filepath or MODEL_FILES['lstm']
    ...
    def __repr__(self):
        ...
        if self.model is None:
            ...
            return f"LSTMModel(params={params:,}, lstm_units={self.lstm_units})"
...
if __name__ == "__main__":
    ...
    test_model = LSTMModel(config=test_config)
